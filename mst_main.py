...
import time
from data_loader import get_loader, MultiSceneDataset
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument('--proj_path', type=str, default='/data/juy220/LU Student Dropbox/Jun Yu/_Vinod/Indoor_Navi/Localization/data/HST_video/Jun')
    # arg_parser.add_argument("labels_file", help="path to a file mapping images to their poses")
    arg_parser.add_argument('--metadata_path', type=str, default='/data/juy220/LU Student Dropbox/Jun Yu/_Vinod/Indoor_Navi/Localization/data/HST_video/Jun/multiscene_train_all.txt')
    arg_parser.add_argument("config_file", help="path to configuration file", default="./HST_config.json")
    ...
    logging.info("Using dataset: {}".format(args.proj_path))
    logging.info("Using labels file: {}".format(args.metadata_path))
    ...
    if args.mode == 'train':
        ...
        dataloader = get_loader(args.model_name, args.proj_path, args.metadata_path, args.mode, False, loader_params["batch_size"], is_shuffle = loader_params["shuffle"], multi_scene = loader_params["multi_scene"])
        ...
        # Set the dataset and data loader
        transform = utils.test_transforms.get('baseline')
        # dataset = CameraPoseDataset(args.dataset_path, args.metadata_path, transform)
        ...
        dataloader = get_loader(args.model_name, args.proj_path, args.metadata_path, args.mode, False,
                                loader_params["batch_size"], is_shuffle=loader_params["shuffle"],
                                multi_scene=loader_params["multi_scene"])
