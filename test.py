...
def main(config):
    ...
    data_loader = get_loader(config.model, config.proj_path, config.metadata_path, config.mode, config.batch_size,
                             config.shuffle)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='Resnet50', choices=['Googlenet', 'Resnet34', 'Resnet', 'Resnet50', 'Resnet101', 'Renet34Simple', 'MobilenetV3'])
    ...
    parser.add_argument('--metadata_path', type=str, default='/data/juy220/LU Student Dropbox/Jun Yu/_Vinod/Indoor_Navi/Localization/data/HST_video/Jun/Lower_Floor/image_test_10.txt')
